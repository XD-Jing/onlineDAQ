...
int main(){
    ...
    sMDT *dec = new sMDT("/home/liji/onlineDAQ/fake_data.dat", "output.root");
    //sMDT *dec = new sMDT("/atlas/data19/liji/onlineDAQback/fake_client/fake_data.dat", "output.root");
